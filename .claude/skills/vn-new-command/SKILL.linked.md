...
- [ ] 5. [`VNScenarioSchema`](../../../Assets/Project/Scripts/VNEffects/Editor/VNScenarioSchema.cs) 登记参数模式（可视化编辑器 UI 自动生成）
- [ ] 6. `VNScenarioEditorWindow.CommandTranslations`（[`Assets/Project/Scripts/VNEffects/Editor/VNScenarioEditorWindow.cs:126`](../../../Assets/Project/Scripts/VNEffects/Editor/VNScenarioEditorWindow.cs#L126)） 加中文名；
      参数若是新的动态来源 → `VNParamSource` + `OptionsFor` + `VNScenarioDoc.Validate`（[`Assets/Project/Scripts/VNEffects/Editor/VNScenarioDoc.cs:532`](../../../Assets/Project/Scripts/VNEffects/Editor/VNScenarioDoc.cs#L532)） 三处补
