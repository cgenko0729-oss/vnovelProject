...
- 音频/Tween 残留由调试重建自动调 `VNAudio.ResetForDebug()`（[`Assets/Project/Scripts/VNEffects/Script/VNAudio.cs:144`](../../../Assets/Project/Scripts/VNEffects/Script/VNAudio.cs#L144)） 清理——
