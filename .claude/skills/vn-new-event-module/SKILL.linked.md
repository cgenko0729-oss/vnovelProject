...
2. 计时用 **`VNTime.Delta`（[`Assets/Project/Scripts/VNEffects/Script/VNPause.cs:144`](../../../Assets/Project/Scripts/VNEffects/Script/VNPause.cs#L144)） / `VNTime.Time`（[`Assets/Project/Scripts/VNEffects/Script/VNPause.cs:148`](../../../Assets/Project/Scripts/VNEffects/Script/VNPause.cs#L148)）**，Tween 加 `SetUpdate(true)`
   （不受 Skip 快进影响，同时**受 [`VNPause`](../../../Assets/Project/Scripts/VNEffects/Script/VNPause.cs) 冻结**——教程弹窗要能冻住你的模块）
...
> 所以还要在 [`Update()`](../../../Assets/Project/Scripts/VNEffects/Script/VNFogScore.cs#L59) **第一行**加 `if (VNPause.IsPaused) return;`，
...
- [ ] 场景生成器里建**禁用**的模板物体挂组件，`VNEventRegistry.modules`（[`Assets/Project/Scripts/VNEffects/Script/VNEventRegistry.cs:25`](../../../Assets/Project/Scripts/VNEffects/Script/VNEventRegistry.cs#L25)） 登记 id
      （实例化到 EventLayer，Canvas 排序 60：ChoicePanel 45 之上、ScreenTransition 100 之下，
      所以可用全屏转场包裹进出事件）
- [ ] [`Update()`](../../../Assets/Project/Scripts/VNEffects/Script/VNFogScore.cs#L59) 首行 `if (VNPause.IsPaused) return;`，dt 走 `VNTime.Delta`（[`Assets/Project/Scripts/VNEffects/Script/VNPause.cs:144`](../../../Assets/Project/Scripts/VNEffects/Script/VNPause.cs#L144)）
