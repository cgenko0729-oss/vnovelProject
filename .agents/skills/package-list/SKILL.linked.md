...
- `sourceFilter` (default `All`) — restrict by Unity `PackageSource`: `All`, [`Registry`](../../../Assets/Project/Scripts/VNEffects/Editor/VNScenarioLinter.cs), `Embedded`, `Local`, `Git`, `BuiltIn`, `LocalTarball`.
